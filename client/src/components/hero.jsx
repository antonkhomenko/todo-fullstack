    ...
    <div> 
     <div className="flex items-top flex-wrap content-stretch gap-y-5 lg:gap-y-0">
        <div className=' flex flex-col gap-y-5 items-center px-6 sm:px-8 lg:w-1/2 lg:pt-12 lg:gap-y-10 2xl:pt-14 2xl:gap-y-12'>
          <h1 className="text-4xl sm:text-5xl lg:text-[4.3rem] font-black  text-white 2xl:w-[80%] 2xl:text-[4.8rem]">
          ...
          <button className='self-stretch py-4 text-xl rounded-md bg-gradient-to-r from-sky-500 to-indigo-500 2xl:w-[80%] 2xl:self-center'>Get started</button>
        </div>
        <div className="flex justify-stretch w-full lg:w-1/2 2xl:justify-end">
          <img src={heroImg} alt="bg-img" className="lg:rounded-l-lg w-full 2xl:w-[90%]"/> 
        </div>
     </div>
