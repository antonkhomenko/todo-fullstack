...
const CarouselItem = ({ person }) => {
  return (
    <div className="bg-stone-800 flex flex-col py-8 px-4 rounded-md shadow-md gap-y-8">
      <div className="flex justify-between">
        <div className="flex items-center gap-2">
          ...
          <p className="font-bold text-lg md:text-xl text-white self-start py-[12px]">{person.name}</p>
        </div>
